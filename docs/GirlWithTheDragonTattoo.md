...
Репортёр из газеты "Дагенс идустрии", явно молодой, временный работник: "Что ж, тебе задали порядочного шороху. Каково это?"  
Несмотря на серьёзность всей ситуации, ни Блумквист, ни журналисты постарше не могли не улыбаться. Микаэль переглянулся в журналисткой с TV4. Каково это? Только полоумные репортёры 
